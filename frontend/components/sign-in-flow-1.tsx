// @ts-nocheck - Three.js types from @react-three/fiber
"use client";
                ...
                {step === "email" ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        <span className="text-white/50 hover:text-white/70 transition-colors cursor-pointer text-sm">
                          Resend code
                        </span>
                      </motion.p>
                    </div>
                  ...
                  >
                    ...
                    >
                      <span className="block w-full rounded-full bg-white text-black font-medium py-3 px-8 hover:bg-white/90 transition-colors">
